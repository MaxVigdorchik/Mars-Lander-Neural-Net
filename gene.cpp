...
void Gene::print_to_file(std::ofstream &outFile) {
  ...
  else outFile<<setprecision (17)<<((lnk->linktrait)->trait_id)<<" ";
  outFile<<setprecision (17)<<(lnk->in_node)->node_id<<" ";
  outFile<<setprecision (17)<<(lnk->out_node)->node_id<<" ";
  outFile<<setprecision (17)<<(lnk->weight)<<" ";
  outFile<<setprecision (17)<<(lnk->is_recurrent)<<" ";
  outFile<<setprecision (17)<<innovation_num<<" ";
  outFile<<setprecision (17)<<mutation_num<<" ";
  outFile<<setprecision (17)<<enable<<std::endl;
}
...
void Gene::print_to_file(std::ostream &outFile) {
	...
	if ((lnk->linktrait)==0) {
		...
		outFile<<setprecision (17)<<((lnk->linktrait)->trait_id)<<" ";
		//char tempbuf2[128];
